    ...
    <div>
      ...
      <div className="bigboy">
        <div className="hero">
          ...
          <Link to="/login">
            <button className="btn btn-dark w-40 mx-auto">Get Started</button>
          </Link>
        </div>
        {/* Information Section 1 */}
        <div className="info-section bg-dark py-3">
          <div className="container">
            <div className="row">
              <div className="col-lg-4 text-light">
                <h2>Quick and Easy</h2>
                <p>
                  Our streamlined process ensures that you can file your
                  insurance claims quickly and easily, reducing stress and
                  hassle.
                </p>
              </div>
              <div className="col-lg-4 text-light">
              ...
              <div className="col-lg-4 text-light">
                ...
                <p>
                  Need help or have questions? Our dedicated customer support
                  team is available 24/7 to assist you. Your satisfaction is our
                  priority.
                </p>
              </div>
            </div>
